...
public class HlsVideoUtil extends  VideoUtil {
    ...
    String video_path = "E:\\cloud实战\\test\\javatest\\1.mp4";
    String m3u8_name = "1.m3u8";
    String m3u8folder_path = "E:\\cloud实战\\test\\javatest\\1\\";
...
//            fileList.add(hls_relativepath+m3u8_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String m3u8_name = "1.m3u8";
        String m3u8folder_path = "E:\\cloud实战\\test\\javatest\\1\\";
        HlsVideoUtil videoUtil = new HlsVideoUtil(ffmpeg_path,video_path,m3u8_name,m3u8folder_path);
