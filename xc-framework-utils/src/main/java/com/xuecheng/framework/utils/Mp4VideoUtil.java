...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "E:\\cms_study(2020329)\\ffmpeg-20180227-fa0c9d6-win64-static\\bin\\ffmpeg.exe";//ffmpeg的安装位置
    String video_path = "E:\\cloud实战\\test\\test1.avi";
    String mp4_name = "test1.mp4";
    String mp4folder_path = "E:\\cloud实战\\test\\javatest\\";
    ...
    public String generateMp4(){
        ...
        /*
        ffmpeg.exe -i  lucene.avi -c:v libx264 -s 1364x768 -pix_fmt yuv420p -b:a 128k -b:v 451k -r 5 .\lucene.mp4
         */
    ...
    public static void main(String[] args) throws IOException {
        ...
        String mp4_path = "E:\\cloud实战\\test\\javatest\\";
